...
def generate_coral_md(
    ...
    if research_enabled:
        ...
        research_section = (
            ...
            "- **Analyze existing solutions** — check your knowledge packet, capsules, shared notes, past attempts, and "
            ...
            f"- **Write a research summary** — save compressed guidance to `{shared_dir}/knowledge/capsules/` "
            f"and findings to `{shared_dir}/knowledge/notes/research/[topic].md` "
